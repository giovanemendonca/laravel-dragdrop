            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 p-3 bg-dark offset-md-1 shadow-lg complete-item" id="complete-item">
                            ...
                            <ul class="list-group connectedSortable" id="complete-item-drop">
                                ...
                                @if(!empty($completeItem) && $completeItem->count())
                                  @foreach($completeItem as $key=>$value)
                                    <li id="bloqued" droppable="disabled: true" class="list-group-item " item-id="{{ $value->id }}">{{ $value->title }}</li>
                                  @endforeach
                                @endif
                            </ul>
                        </div>                    
